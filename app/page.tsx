  ...
  return (
    <div className="flex min-h-screen flex-col  p-10 bg-[#FFF8DB] gap-8">
      <div className="flex flex-row items-center justify-between gap-17">
        ...
        <Link href="/createAccount" className="bg-[#EE7421] rounded-2xl text-white p-3">Create Account</Link>
      </div>
      ...
      <div className="flex flex-row items-center gap-5">
        ...
        <Link href="/createAccount" className="bg-[#EE7421] rounded-2xl text-white p-3.5">Create Account</Link>
      </div>
    </div>
  );
}
